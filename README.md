...
En développement local, RustFS fournit une API S3 compatible sur `http://localhost:9000` et une console sur [http://localhost:9002](http://localhost:9002). Le bucket local créé par défaut est `ban-exports`.
