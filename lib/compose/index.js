...
async function buildVoies(rawAdressesCommune, {pseudoCodeVoieGenerator, codeCommune}) {
  ...
  return consolidateVoies(filteredAdresses, {pseudoCodeVoieGenerator, codeCommune})
}
...
async function composeCommune(codeCommune) {
  ...
  const composedVoies = await buildVoies(rawAdressesCommune, {codeCommune, pseudoCodeVoieGenerator})
