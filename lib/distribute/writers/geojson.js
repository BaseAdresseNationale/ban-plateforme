...
function adresseToFeature(a) {
  return {
    type: 'Feature',
    properties: pick(a, 'numero', 'suffixe', 'idVoie', 'nomVoie', 'codeCommune', 'nomCommune', 'sources', 'sourcePosition', 'positionType', 'id', 'codeAncienneCommune', 'nomAncienneCommune', 'sourceNomVoie'),
    geometry: a.position
  }
}
