...
async function getPopulatedVoie(idVoie) {
  ...
  const numerosFields = ['numero', 'uidAdresse', 'suffixe', 'lieuDitComplementNom', 'lieuDitComplementNomAlt', 'parcelles', 'sources', 'position', 'positionType', 'sourcePosition', 'certifie', 'codePostal', 'libelleAcheminement', 'id', 'dateMAJ']
