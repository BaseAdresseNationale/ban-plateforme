...
async function askComposition(codeCommune, options = {}, forceWithBanId) {
  ...
  await compositionQueue.add({codeCommune: communeActuelle.code, compositionAskedAt: now, forceWithBanId}, {removeOnComplete: true})
}
