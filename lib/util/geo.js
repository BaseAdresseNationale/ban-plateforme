...
function distanceToPolygon(point, polygon) {
  ...
  return min(getRings(polygon).map(ring => {
    return pointToLineDistance(point, lineString(ring))
  }))
}

module.exports = {computeBufferedBbox, derivePositionProps, getCenterFromPoints, distanceToPolygon}
