...
export const DistrictConfig = sequelize.define('DistrictConfig', {
  districtId: {
    type: DataTypes.UUID,
    primaryKey: true,
    field: 'district_id',
  ...
  range_validity: { // eslint-disable-line camelcase -- défini par le trigger INSERT côté SQL
    type: DataTypes.RANGE(DataTypes.DATE),
    allowNull: true,
  },
}, {
  schema: 'ban',
  tableName: 'district_config',
  timestamps: true,
})
