...
const MONGODB_URL = MONGODB_USER && MONGODB_PASSWORD ? `mongodb+srv://${MONGODB_USER}:${MONGODB_PASSWORD}@${MONGODB_HOST}/${MONGODB_DBNAME}?replicaSet=replicaset&tls=true&authSource=admin` : process.env.MONGODB_URL || 'mongodb://localhost'
