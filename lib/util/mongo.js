...
class Mongo {
  ...
  async createIndexes() {
    ...
    await this.db.collection('composition_communes').createIndex({compositionAskedAt: 1}, {sparse: true})
    await this.db.collection('composition_communes').createIndex({codeCommune: 1})
  }
