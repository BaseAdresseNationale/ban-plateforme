...
class SourceDb {
  constructor(sourceName) {
    this.db = new Keyv(`sqlite://db/source-${sourceName}.sqlite`, {busyTimeout: 30000})
  }
  ...
  async getCommune(codeCommune) {
    ...
    if (!commune) {
      console.log(`Commune inconnue : ${codeCommune}`)
      return []
    }
...
class MergeDb {
  constructor(mergeName) {
    this.db = new Keyv(`sqlite://db/merge-${mergeName}.sqlite`, {busyTimeout: 30000})
  }
