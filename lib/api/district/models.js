...
export const enableDistrictAddressingCertification = districtID => {
  District.update({config: {certificate: {}}}, {where: {id: districtID}})
}

export const getDistrictAddressingCertification = districtID => {
  District.findBy({where: {id: districtID}})
}
