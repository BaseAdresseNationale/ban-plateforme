...
app.patch('/addressing-certification/enable',
  ...
  async (req, res) => {
    try {
      ...
      console.log('activationDistrictAddressingCertification', activationDistrictAddressingCertification)
      ...
      console.log('activationCommuneAddressingCertification', activationCommuneAddressingCertification)
