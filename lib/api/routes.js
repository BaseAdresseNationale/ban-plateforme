...
const {getPopulatedVoie, getPopulatedNumero, getPopulatedCommune, getAdressesFeatures} = require('../models/commune')
...
app.get('/tiles/ban/:z/:x/:y', w(async (req, res) => {
  ...
  req.layersFeatures = {
    adresses: await getAdressesFeatures(req.z, req.x, req.y)
  }
