 ...
 *   post:
 *     summary: Suppression en masse de toponymes communs
 *     description: Supprime plusieurs toponymes communs par leurs identifiants.
 *     tags:
 *       - common-toponym
 *     security:
 *       - bearerAuth: []
 ...
 *   post:
 *     summary: Générer un rapport de delta pour les toponymes communs
 *     description: Crée un rapport de delta basé sur les données fournies et l'identifiant du districtD.
 *     tags:
 *       - common-toponym
 *     security:
 *       - bearerAuth: []
