import {Address, sequelize} from '../../util/sequelize.js'
...
export const getAddressesForDeltaReport = (filters, extraAttributes = []) =>
  Address.findAll({
    where: filters,
...
export const getAddressesCountByDistrict = districtID =>
  Address.count({
    where: {
      districtID,
      isActive: true
