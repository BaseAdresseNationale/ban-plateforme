...
const pathToMockBalJSON1 = './apps/bal-parser/data-mock/adresses-21286_cocorico.json';
const mockBalJSONstr1 = fs.readFileSync(pathToMockBalJSON1, 'utf8');
const balJSON1 = JSON.parse(mockBalJSONstr1);

const pathToMockBalJSON2 = './apps/bal-parser/data-mock/adresses-21286_cocorico.1.4.json';
